...
export const tools: Tool[] = [
  {
    ...
    category: "converters",
    keywords: ["json formatter", "json validator", "json beautifier", "format json online", "pretty print json", "minify json", "formatear json"],
    icon: Braces,
    available: true,
    guide: "Pega tu JSON, corrige los errores de sintaxis si aparecen, elige el nivel de indentación y copia el resultado limpio o minificado.",
    faq: [
      {
        question: "¿Funciona con JSON grande?",
        answer: "Sí, está pensado para pegar y formatear respuestas de API, configuraciones y objetos grandes sin complicaciones.",
      },
      {
        question: "¿Mis datos se envían a un servidor?",
        answer: "No. El formateo y la validación se hacen directamente en tu navegador.",
      },
      {
  ...
  },
  {
    ...
    category: "generators",
    keywords: ["password generator", "random password", "strong password", "secure password", "generador de contraseñas"],
    icon: KeyRound,
    available: true,
    ...
    faq: [
      {
        question: "¿La contraseña se genera de forma segura?",
        answer: "Sí. Usa el generador criptográfico del navegador para crear contraseñas aleatorias.",
      },
      {
        question: "¿Se guarda mi contraseña?",
        answer: "No. Todo se genera localmente y no se envía a ningún servidor.",
      },
      {
        question: "¿Puedo ajustar la longitud?",
  ...
  },
  {
    ...
    category: "generators",
    keywords: ["qr code generator", "qr code maker", "create qr code", "generador de qr"],
    icon: QrCode,
    available: true,
